...
namespace TestLeetcode
{
    ...
    { 
        ...
        {
            var head = LinkedList.BuildListNodeFromArray(new[] {1, 2, 3, 4, 5});
        ...
        {
            var head1 = LinkedList.BuildListNodeFromArray(new[] { 1, 2, 4 });
            var head2 = LinkedList.BuildListNodeFromArray(new[] { 1, 3, 4 });
        ...
        {
            var head1 = LinkedList.BuildListNodeFromArray(new[] { 1, 4, 5 });
            var head2 = LinkedList.BuildListNodeFromArray(new[] { 1, 3, 4 });
            var head3 = LinkedList.BuildListNodeFromArray(new[] { 2, 6 });
            var head4 = LinkedList.BuildListNodeFromArray(new[] { 7 });
            var head5 = LinkedList.BuildListNodeFromArray(new[] { 8 });
            var head6 = LinkedList.BuildListNodeFromArray(new[] { 9 });
            var head7 = LinkedList.BuildListNodeFromArray(new[] { 10 });
            var head8 = LinkedList.BuildListNodeFromArray(new[] { 11 });
            var head9 = LinkedList.BuildListNodeFromArray(new[] { 12 });
        ...
        {
            var head1 = LinkedList.BuildListNodeFromArray(new[] { 1, 2, 3, 4});
            SwapNodeInPair.Swap(head1);

            Assert.AreEqual(head1.Next.Next.Next.Val, 4);
            Assert.AreEqual(head1.Next.Val, 2);

            var head2 = LinkedList.BuildListNodeFromArray(new[] { 1, 2, 3, 4, 5 });
